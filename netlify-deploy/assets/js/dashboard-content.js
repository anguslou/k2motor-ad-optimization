    ...
    constructor() {
        ...
        this.metricTooltips = {
            ...
            'realroi': {
                ...
                why: 'Calculates true profit by factoring in product costs and margins.',
                action: 'This is the true measure of profitability. Positive ROI means the campaign is making money.'
            },
            'poas': {
                title: 'Profit on Ad Spend',
                why: 'Similar to Real ROI, this measures the profit generated from ad spend.',
                action: 'POAS > 1x means the campaign is profitable.'
            },
            'totalrevenue': {
                title: 'Total Revenue',
            ...
            <div class="attribution-dashboard">
                ...
                <section class="roas-comparison-section">
                    <div class="section-header">
                        <h3>
                            <span class="tooltip">📊 Apparent vs True ROAS Analysis
                                <span class="tooltiptext">
                                    <div class="tooltip-section">
                                        ...
                                        <div class="tooltip-action">Use True ROAS (not platform numbers) for all budget decisions</div>
                                    </div>
                                </span>
                            </span>
                        </h3>
                        <p>
                            <span class="tooltip">Comparing platform-reported ROAS with cross-brand control group measurements
                                <span class="tooltiptext">
                                    <div class="tooltip-section">
                                        <span class="tooltip-title">Why Platform Numbers Are Wrong</span>
                                        <div class="tooltip-why">Platforms claim credit for all sales, even ones that would happen without ads</div>
                                        <div class="tooltip-action">Attribution gaps >30% mean platforms are significantly overstating your performance</div>
                                    </div>
                                </span>
                            </span>
                        </p>
